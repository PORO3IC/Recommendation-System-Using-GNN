...
class Data(object):
    ...
    def sample_check_graph(self):
        users = torch.LongTensor([1, 93, 110, 268, 540, 610])
        items = torch.LongTensor([168174,1129,2248,2541])
    ...
    def get_degree(self):
        check_item1 = [3300,4148,4679,168174,1129,2248,2541,107406]
        check_item2 = [1262,1302,1401,1465,260,110,99114,122892,86880,53121,53519,60040,7090]
...
if __name__ == "__main__":
    data_generator = Data(path="Data/movie-lens-100k", batch_size=16)
